...
Run from the repo root::
    ...
    python3 benchmarks/profile_coopt_reorder_move.py --calibrate
    python3 benchmarks/profile_coopt_reorder_move.py
    python3 benchmarks/profile_coopt_reorder_move.py --report
"""
...
REPORT_MD = os.path.join(_BENCH, f"coopt_reorder_move{_SUF}.md")
FRONTIER_PNG = os.path.join(_RESULTS, f"coopt_reorder_frontier{_SUF}.png")
ISOTIME_PNG = os.path.join(_RESULTS, f"coopt_reorder_isotime{_SUF}.png")
...
def write_report():
    ...
    out.append(f"![isotime](results/{os.path.basename(ISOTIME_PNG)})\n")
