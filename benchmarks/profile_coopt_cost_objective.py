...
Run from the repo root::
    ...
    python3 benchmarks/profile_coopt_cost_objective.py
    python3 benchmarks/profile_coopt_cost_objective.py --smoke
    python3 benchmarks/profile_coopt_cost_objective.py --report
"""
...
REPORT_MD = os.path.join(_BENCH, "coopt_cost_objective.md")
