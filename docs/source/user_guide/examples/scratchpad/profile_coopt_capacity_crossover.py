...
Run from the repo root::
    ...
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_capacity_crossover.py
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_capacity_crossover.py --smoke
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_capacity_crossover.py --report
"""
...
REPORT_MD = os.path.join(_REPORTS, "coopt_capacity_crossover.md")
PNG = os.path.join(_IMAGES, "coopt_capacity_crossover.png")
...
def write_report():
    ...
    out.append(f"![crossover](../../_static/images/coopt/{os.path.basename(PNG)})\n")
    for mv in MOVES:
        by = _by_ratio(data, mv)
        out.append(f"\n## reorder_move = `{mv}`\n")
        out.append(
