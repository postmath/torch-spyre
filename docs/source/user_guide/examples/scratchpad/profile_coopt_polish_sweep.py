...
Run from the repo root::
    ...
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_polish_sweep.py            # sweep + report
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_polish_sweep.py --smoke
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_polish_sweep.py --report
"""
...
REPORT_MD = os.path.join(_REPORTS, "coopt_polish_sweep.md")
LINES_PNG = os.path.join(_IMAGES, "coopt_polish_lines.png")
