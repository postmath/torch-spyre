...
Run from the repo root::
    ...
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_move_weights.py --calibrate
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_move_weights.py
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_move_weights.py --report
"""
...
REPORT_MD = os.path.join(_REPORTS, "coopt_move_weights.md")
FRONTIER_PNG = os.path.join(_IMAGES, "coopt_move_weights_frontier.png")
