...
Run from the repo root::
    ...
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_band_retune.py
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_band_retune.py --smoke
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_band_retune.py --report
"""
