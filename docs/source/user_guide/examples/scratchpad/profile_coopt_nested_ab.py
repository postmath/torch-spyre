...
Run from the repo root::
    ...
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_nested_ab.py            # full A/B + report
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_nested_ab.py --smoke    # tiny subset
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_nested_ab.py --memory-only
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_nested_ab.py --report   # report only
"""
...
REPORT_MD = os.path.join(_REPORTS, "coopt_nested_ab.md")
DELTA_PNG = os.path.join(_IMAGES, "coopt_nested_delta.png")
FRONTIER_PNG = os.path.join(_IMAGES, "coopt_nested_frontier.png")
...
def write_report():
    ...
    out.append(f"![delta](../../_static/images/coopt/{os.path.basename(DELTA_PNG)})\n")
    out.append(
