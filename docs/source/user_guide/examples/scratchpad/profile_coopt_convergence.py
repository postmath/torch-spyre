...
Run from the repo root::
    ...
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_convergence.py
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_convergence.py --smoke
    python3 docs/source/user_guide/examples/scratchpad/profile_coopt_convergence.py --report
"""
...
REPORT_MD = os.path.join(_REPORTS, "coopt_convergence.md")
CURVES_PNG = os.path.join(_IMAGES, "coopt_convergence_curves.png")
...
def write_report():
    ...
    out.append(
        f"\n![curves](../../_static/images/coopt/{os.path.basename(CURVES_PNG)})\n"
    )
